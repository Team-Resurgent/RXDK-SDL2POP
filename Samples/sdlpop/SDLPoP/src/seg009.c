...
#endif
	SDL_GameControllerAddMapping(",Original Xbox Controller,a:b0,b:b1,x:b2,y:b3,rightshoulder:b4,leftshoulder:b5,start:b8,back:b9,leftstick:b10,rightstick:b11,dpdown:h0.4,dpleft:h0.8,dpright:h0.2,dpup:h0.1,leftx:a0,lefty:a1,rightx:a2,righty:a3,lefttrigger:b6,righttrigger:b7");
